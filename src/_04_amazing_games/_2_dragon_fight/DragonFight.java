...
public class DragonFight {
	...
	int dragonAttack = 0;
		...
		while (true) {
			...
			if (input == "yell" || input.equals("yell")) {
				playerAttack = ran.nextInt(50);
			}
					  // -- Find a random number between 0 and 10 and store it in playerAttack. Use
					  // ran.nextInt(10)
			if (input == "kick" || input.equals("kick")) {
...
JOptionPane.showMessageDialog(null, "the dragon has been defeated and you have a ton of gold!");
		System.exit(0);   //This code ends the program
	}
